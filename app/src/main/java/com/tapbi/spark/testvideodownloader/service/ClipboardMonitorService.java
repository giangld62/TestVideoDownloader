...
package com.tapbi.spark.testvideodownloader.service;
...
public class ClipboardMonitorService extends Service {
    ...
    private static final String FILENAME = "clipboard_history.txt";
    ...
    public void onCreate() {
        ...
        mHistoryFile = new File(getFilesDir(), FILENAME);
        mClipboardManager =
